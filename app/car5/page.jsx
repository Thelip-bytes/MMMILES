...
import styles from "./car5.module.css";
...
const faqData = [
  {
    id: 1,
    question: "What engine options does the Baleno 2025 have?",
    answer: "It is powered by a 1.2 L DualJet petrol engine, available with a 5-speed manual transmission.",
  },
  {
    id: 2,
    question: "Is the Baleno spacious enough for a family of 5?",
    answer: "Yes, it comfortably accommodates 5 adults with ample legroom, headroom, and a roomy boot for luggage.",

  },
  {
    id: 3,
    question: "Does the Baleno 2025 have a 360-degree camera?",
    answer: "Yes, higher trims like Zeta and Alpha are equipped with a 360-degree view camera for better parking and safety.",
  },
  {
    id: 4,
    question: "Does the Baleno 2025 offer a CNG option?",
    answer: "Yes, the Baleno 2025 is available with a factory-fitted S-CNG kit, delivering excellent mileage and lower running costs.",
  },
  {
    id: 5,
    question: "Does the Baleno 2025 have cruise control?",
    answer: "Yes, the Baleno 2025 offers cruise control in higher variants, making highway drives more comfortable and relaxed.",
  },
  {
    id: 6,
    question: "Does the Baleno 2025 support wireless CarPlay?",
    answer: "Yes, the 9-inch SmartPlay Pro+ infotainment system supports wireless Android Auto and Apple CarPlay.",
...
const blurCardsData = [
  ...
  { id: 2, title: "Display", subtext: "7inches Smart Play Pro+ LED", color: "green" },
  { id: 3, title: "Safety", subtext: "6 Airbags", color: "cyan" },
  { id: 4, title: "Engine", subtext: "1197 CC", color: "blue" },
  { id: 5, title: "Clean", subtext: "Before renting CAR is washed", color: "green" },
  { id: 6, title: "Precaution", subtext: "Serviced after every ride", color: "cyan" },
];
// Data for the new stats section
const statsData = [
    { number: "2024", label: "Car Model" },
    { number: "14657", label: "Driven Record" },
    { number: "018", label: "Kilometer / liter" },
    { number: "139", label: "Top speed / hour" },
];
...
const carDetails = {
  ...
  pricePerDay: 2699,
  description: "The Maruti Suzuki Baleno is a stylish premium hatchback known for its sleek design and spacious interiors.It offers a smooth and efficient driving experience with advanced features for comfort and safety.",


  // Combine all images and the video into a single array of objects
  allImages: [
    { src: "/fronx1.jpg", type: "image" },
    { src: "/fronx2.jpg", type: "image" },
    { src: "/fronx3.jpg", type: "image" },
    { src: "/fronx4.jpg", type: "image" },
    //{ src: "/carvideo.png", type: "video" }, // Added a type property for the video
    { src: "/fronx5.jpg", type: "image" },
