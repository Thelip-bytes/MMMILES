...
export default function Footer() {
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContainer}>
          ...
          <div className={styles.footerLeft}>
            ...
            <p>Office Number: <a href="tel:9096299666"> +91 9096299666</a></p>
            <p>Email: <a href="Mailto:urbandrive.chennai@gmail.com"> urbandrive.chennai@gmail.com</a></p>
            </div>
  ...
  <div className={styles.socialIcons}>
    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
      <Image src="/instagram.png" alt="Instagram" width={66} height={29} />
    </a>
    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
      <Image src="/facebook.png" alt="Facebook" width={66} height={29} />
    </a>
    <a href="https://wa.me/919096299666" target="_blank" rel="noopener noreferrer">
      <Image src="/whatsapp.png" alt="WhatsApp" width={66} height={29} />
    </a>
  </div>
</div>
