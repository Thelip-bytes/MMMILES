...
import styles from "./car7.module.css";
...
const faqData = [
  {
    id: 1,
    question: "What are the available engine options?",
    answer: "It offers 2 engine options: 2.7-liter petrol engine and 2.8-liter diesel engine. Both come with manual or automatic transmission options.",
  },
  {
    id: 2,
    question: "What is the ground clearance of the Toyota Fortuner?",
    answer: "The ground clearance is generally around 225 mm, which is high and contributes to its off-road capability.",
  },
  {
    id: 3,
    question: "Does the current Toyota Fortuner have a sunroof?",
    answer: "The current generation of the Toyota Fortuner in India does not typically offer a factory-fitted sunroof in any of its variants.",
  },
  {
    id: 4,
    question: "What is the boot space capacity of Fortuner?",
    answer: "The standard boot space is approximately 296 liters (with the third row of seats in use or folded up).",
  },
  {
    id: 5,
    question: "What are the approximate dimensions?",
    answer: "The Fortuner is approximately $4795 \text{ mm}$ (Length) x $1855 \text{ mm}$ (Width) x $1835 \text{ mm}$ (Height).",
  },
  {
    id: 6,
    question: "What is the body type of the Fortuner?",
    answer: "It is a traditional SUV built on a rugged body-on-frame (ladder frame) chassis, which is excellent for durability and off-roading.",
...
const blurCardsData = [
  { id: 1, title: "Service", subtext: "Low-maintenance", color: "blue" },
  { id: 2, title: "Display", subtext: "8inches LED", color: "green" },
  { id: 3, title: "Safety", subtext: "7 SRS Airbags", color: "cyan" },
  { id: 4, title: "Engine", subtext: "2982 CC", color: "blue" },
  { id: 5, title: "Clean", subtext: "Routine Cleaning", color: "green" },
  { id: 6, title: "Precaution", subtext: "Driving Safety", color: "cyan" },
];
// Data for the new stats section
const statsData = [
    { number: "2020", label: "Car Model" },
    { number: "14011", label: "Driven Record" },
    { number: "009", label: "Kilometer / liter" },
    { number: "190", label: "Top speed / hour" },
];
...
const carDetails = {
  ...
  pricePerDay: 4000,
  description: "The Toyota Fortuner's specialty is its proven reliability and versatility as a powerful, rugged, seven-seater SUV. It excels on both city roads and rough terrain due to strong engine options, optional 4x4 capability, and a tough body-on-frame chassis.",
  ...
  allImages: [
    { src: "/fortuner1.jpg", type: "image" },
    { src: "/fortuner2.jpg", type: "image" },
    { src: "/fortuner3.jpg", type: "image" },
    { src: "/fortuner4.jpg", type: "image" },
    //{ src: "/carvideo.png", type: "video" }, // Added a type property for the video
    { src: "/fortuner5.jpg", type: "image" },
