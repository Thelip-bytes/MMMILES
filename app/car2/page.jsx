...
const faqData = [
  {
    id: 1,
    question: "Does the Fronx come with a turbo engine option?",
    answer: "Yes, it offers a 1.0L Turbo Boosterjet engine delivering strong performance with impressive fuel efficiency.",
  },
  {
    id: 2,
    question: "Can I get a premium sound system in the Fronx?",
    answer: "Yes, it offers an Arkamys-tuned surround sound system for an immersive audio experience.",
  },
  {
    id: 3,
    question: "How is the safety rating of the Fronx?",
    answer: "It comes with Suzuki’s HEARTECT platform, 6 airbags (in top trims), ESP, and hill-hold assist for enhanced safety.",
  },
  {
    id: 4,
    question: "Is the Fronx spacious enough for a family of 5?",
    answer: "Yes, it comfortably seats 5 adults with ample legroom and headroom, plus a spacious boot for luggage.",
  },
  {
    id: 5,
    question: "Does the Fronx have a 360-degree camera?",
    answer: " Yes, the Maruti Suzuki Fronx (higher trims like Alpha and select Zeta variants) come equipped with a 360-degree camera system.",
  },
  {
    id: 6,
    question: "Does it support wireless Android & Apple CarPlay?",
    answer: "Yes, the 9-inch SmartPlay Pro+ infotainment system supports wireless Android Auto/Apple CarPlay with OTA updates.",
...
const blurCardsData = [
  ...
  { id: 2, title: "Display", subtext: "7inches LED", color: "green" },
  { id: 3, title: "Safety", subtext: "6 Airbags", color: "cyan" },
  { id: 4, title: "Engine", subtext: "1250 CC", color: "blue" },
...
const statsData = [
    ...
    { number: "17049", label: "Driven Record" },
    { number: "021", label: "Kilometer / liter" },
    { number: "149", label: "Top speed / hour" },
];
...
const carDetails = {
  ...
  pricePerDay: 2999,
  description: "Maruti Suzuki Fronx blends bold SUV styling with cutting-edge technology, redefining compact luxury. Engineered for power and efficiency, it offers turbo performance with unmatched driving comfort.",
  ...
  allImages: [
    { src: "/fronx-i1.jpg", type: "image" },
    { src: "/fronx11.jpg", type: "image" },
    { src: "/fronx-i3.jpg", type: "image" },
    { src: "/fronx-i4.jpg", type: "image" },
    //{ src: "/carvideo.png", type: "video" }, // Added a type property for the video
    { src: "/fronx-i5.png", type: "image" },
