...
import styles from "./car6.module.css";
...
const faqData = [
  {
    ...
    answer: "It is offered with a 1.2-litre i-VTEC naturally aspirated petrol engine. Older generations had a 1.5-litre i-DTEC diesel engine option.",
  },
  {
    id: 2,
    question: "What are the transmission options in Amaze?",
    answer: "The 1.2L petrol engine is available with both a 5-speed Manual Transmission and a Continuously Variable Transmission automatic.",
  },
  {
    id: 3,
    question: "What is the claimed mileage (fuel efficiency)?",
    answer: "The mileage of petrol engine is approximately 18.65 kmpl for the Manual variant and 19.46 kmpl for the Automatic variant. ",
  },
  {
    id: 4,
    question: "What are the standard safety features?",
    answer: "It include Dual Front Airbags, Anti-lock Braking System with Electronic Brakeforce Distribution, and ISOFIX Child Seat Mounts.",
  },
  {
    id: 5,
    question: "Does Amaze have a touchscreen infotainment system?",
    answer: "Yes, it comes with an advanced touchscreen display audio system, featuring connectivity like Android Auto and Apple CarPlay.",
  },
  {
    id: 6,
    question: "Does it have ADAS (Advanced Driver-Assistance Systems)?",
    answer: "Some of the latest models or top variants of the Honda Amaze (in certain markets) are equipped with Honda's ADAS features.",
...
const blurCardsData = [
  ...
  { id: 2, title: "Display", subtext: "Apple CarPlay", color: "green" },
  { id: 3, title: "Safety", subtext: "Dual Airbags", color: "cyan" },
  { id: 4, title: "Engine", subtext: "1497 CC", color: "blue" },
  { id: 5, title: "Clean", subtext: "Regular washing", color: "green" },
  { id: 6, title: "Precaution", subtext: "Fasten your seat belt", color: "cyan" },
];
// Data for the new stats section
const statsData = [
    { number: "2017", label: "Car Model" },
    { number: "17490", label: "Driven Record" },
    { number: "018", label: "Kilometer / liter" },
    { number: "160", label: "Top speed / hour" },
];
...
const carDetails = {
  name: "Honda AMAZE",
  pricePerDay: 1999,
  description: "The Honda Amaze is a popular subcompact sedan in India, known for its spacious cabin and practical design. It features a reliable i-VTEC petrol engine with both manual and efficient CVT automatic options. The Amaze competes as a value-for-money option.",
  ...
  allImages: [
    { src: "/honda1.jpg", type: "image" },
    { src: "/honda2.jpg", type: "image" },
    { src: "/honda3.jpg", type: "image" },
    { src: "/honda4.jpg", type: "image" },
    //{ src: "/carvideo.png", type: "video" }, // Added a type property for the video
    { src: "/honda5.jpg", type: "image" },
