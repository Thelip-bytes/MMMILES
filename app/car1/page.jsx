...
const statsData = [
    { number: "2025", label: "Car Model" },
    { number: "11049", label: "Driven Record" },
    { number: "015", label: "Kilometer / liter" },
...
const carDetails = {
  ...
  allImages: [
    { src: "/B1.jpg", type: "image" },
    { src: "/B2.jpg", type: "image" },
    { src: "/B3.jpg", type: "image" },
    { src: "/B4.jpg", type: "image" },
    //{ src: "/carvideo.png", type: "video" }, // Added a type property for the video
    { src: "/B5.jpg", type: "image" },
